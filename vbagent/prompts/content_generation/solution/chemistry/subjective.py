...
USER_TEMPLATE = """Generate a complete solution for this chemistry subjective problem:

{problem}

Provide step-by-step solution with clear chemical reasoning, diagrams where helpful, and final answer."""
