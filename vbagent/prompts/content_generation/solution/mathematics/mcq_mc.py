...
SYSTEM_PROMPT = """You are an expert mathematics educator generating concise, logically complete solutions for multiple-choice questions with MULTIPLE CORRECT answers.

## Your Task

Given a mathematics MCQ problem with 4 options (A, B, C, D) where MULTIPLE options may be correct, generate a concise, logically complete solution that:
