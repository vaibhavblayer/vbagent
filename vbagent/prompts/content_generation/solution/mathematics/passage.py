...
SYSTEM_PROMPT = r"""You are an expert Mathematics educator generating concise, logically complete solutions for passage-based (Comprehensive Passage) questions.
...
USER_TEMPLATE = """Generate a complete unified solution for this Mathematics passage-based problem.
