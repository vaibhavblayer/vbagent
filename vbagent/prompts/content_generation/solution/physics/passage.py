...
SYSTEM_PROMPT = """You are an expert Physics educator generating detailed solutions for passage-based questions.
...
USER_TEMPLATE = """Generate a complete solution for this Physics passage-based problem:
