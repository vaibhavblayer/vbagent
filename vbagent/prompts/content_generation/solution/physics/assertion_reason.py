"""Solution generation prompt for physics Assertion-Reason questions.
...
[relevant physics equations or reasoning]
...
USER_TEMPLATE = """Generate a complete solution for this physics Assertion-Reason problem:
