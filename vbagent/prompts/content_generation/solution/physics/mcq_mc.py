"""Solution generation prompt for physics MCQ (multiple correct) questions.
...
- Show key physics reasoning for each option
...
USER_TEMPLATE = """Generate a complete solution for this physics MCQ (multiple correct) problem:
