...
_PROMPTS = build_topic_prompts(
    subjective_intro="You are an expert physics educator solving electrostatics problems (electric fields, potential, Gauss's law, capacitors).",
    mcq_intro='You are an expert physics educator solving electrostatics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving electrostatics MCQ (multiple correct) problems.',
