...
_PROMPTS = build_topic_prompts(
    subjective_intro='You are an expert physics educator solving atomic and nuclear physics problems (Bohr model, X-rays, radioactivity, nuclear reactions, binding energy).',
    mcq_intro='You are an expert physics educator solving atomic and nuclear physics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving atomic and nuclear physics MCQ (multiple correct) problems.',
