...
_PROMPTS = build_topic_prompts(
    subjective_intro='You are an expert physics educator solving modern physics problems (photoelectric effect, Compton scattering, de Broglie waves, uncertainty, relativity).',
    mcq_intro='You are an expert physics educator solving modern physics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving modern physics MCQ (multiple correct) problems.',
