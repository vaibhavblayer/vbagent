...
_PROMPTS = build_topic_prompts(
    subjective_intro='You are an expert physics educator solving wave optics problems (interference, diffraction, polarization, YDSE, thin films).',
    mcq_intro='You are an expert physics educator solving wave optics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving wave optics MCQ (multiple correct) problems.',
