...
_PROMPTS = build_topic_prompts(
    subjective_intro="You are an expert physics educator solving electromagnetism problems (EMI, Faraday's law, Lenz's law, AC circuits, transformers).",
    mcq_intro='You are an expert physics educator solving electromagnetism MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving electromagnetism MCQ (multiple correct) problems.',
