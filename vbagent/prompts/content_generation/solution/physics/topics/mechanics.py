...
_PROMPTS = build_topic_prompts(
    subjective_intro='You are an expert physics educator solving mechanics problems (kinematics, dynamics, forces, friction, circular motion).',
    mcq_intro='You are an expert physics educator solving mechanics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving mechanics MCQ (multiple correct) problems.',
    topic_concepts=TOPIC_CONCEPTS,
    common_patterns=COMMON_PATTERNS,
    diagram_guidance=DIAGRAM_GUIDANCE,
    typical_mistakes=TYPICAL_MISTAKES,
    subjective_diagram_requirements='List of diagrams needed (use mechanics diagram for setup, FBD for force analysis)',
)
