...
_PROMPTS = build_topic_prompts(
    subjective_intro='You are an expert physics educator solving ray optics problems (reflection, refraction, lenses, mirrors, prisms, TIR).',
    mcq_intro='You are an expert physics educator solving ray optics MCQ problems.',
    mcq_mc_intro='You are an expert physics educator solving ray optics MCQ (multiple correct) problems.',
