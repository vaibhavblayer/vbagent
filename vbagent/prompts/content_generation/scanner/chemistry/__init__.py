"""Chemistry-specific scanner prompts.

Scanner prompts for chemistry questions with chemistry-specific:
- Solution structure (mhchem equations, oxidation states)
- Notation (chemical formulas, ions, electron configurations)
- Packages (chemfig, mhchem, TikZ for energy diagrams)
- Diagram types (organic structures, Lewis structures, energy diagrams)
"""
...
def get_prompt(question_type: str) -> str:
    """Get chemistry scanner prompt for a question type.
