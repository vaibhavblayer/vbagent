...
QUESTION_TYPE_GUIDANCE = r"""Question type cues and evidence:
...
- integer: The response is explicitly constrained to an integer/numerical entry and the LaTeX uses an ``\\ansint{...}`` marker. Do not classify an integer-response item as subjective merely because it has no options.
