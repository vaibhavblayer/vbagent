...
Generates pure geometry diagrams: triangles, polygons, circles,
...
def create_geometric_figure_agent(use_context: bool = True) -> "Agent":
    """Create a geometric figure generation agent.
    ...
    if use_context:
        context = get_geometric_figure_context_for_classification()
        if context:
            prompt = prompt + "\n\n" + context
...
def generate_geometric_figure(
    image_path: Optional[str] = None,
    description: Optional[str] = None,
    use_context: bool = True,
    show_spinner: bool = True,
) -> str:
    """Generate TikZ code for a geometric figure.
    
    Args:
        image_path: Path to figure image (optional)
        description: Text description of figure (optional)
        use_context: Whether to include reference context
    ...
    agent = create_geometric_figure_agent(use_context)
...
def validate_geometric_figure_output(tikz_code: str) -> tuple[bool, str]:
    """Validate TikZ code for geometric figures.
...
def get_geometric_figure_context_for_classification() -> str:
    """Get reference context for geometric figure generation.
    ...
    results = store.search(
        query="geometry triangle polygon circle angle construction proof",
    ...
    context = "\n\n## Reference Examples\n\n"
    context += "Here are some similar geometric figures from our reference library:\n\n"
