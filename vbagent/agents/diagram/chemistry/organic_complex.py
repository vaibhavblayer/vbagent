"""Complex organic molecule diagram agent using chemfig.

Specializes in polycyclic systems, natural products, and large biomolecules.
"""
...
from vbagent.prompts.diagram.chemistry import organic_complex
from vbagent.utils.latex import clean_latex_output


def generate_complex_molecule(
    ...
    """Generate chemfig code for a complex organic molecule.
    ...
    # Format context info
    context_info = organic_complex.format_context_info(chemistry_context or {})
    
    # Create agent
    agent = create_agent(
        name="ComplexMoleculeSpecialist",
        instructions=organic_complex.SYSTEM_PROMPT,
        agent_type="tikz",
    )
    ...
    if image_path:
        ...
        user_prompt = organic_complex.USER_TEMPLATE.replace(
