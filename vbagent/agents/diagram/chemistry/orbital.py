...
Generates atomic and molecular orbital diagrams, electron configurations,
...
def create_orbital_agent(use_context: bool = True) -> "Agent":
    """Create an orbital diagram generation agent.
    ...
    if use_context:
        context = get_orbital_context_for_classification()
        if context:
            prompt = prompt + "\n\n" + context
...
def generate_orbital(
    ...
    """Generate TikZ code for an orbital diagram.
    ...
    agent = create_orbital_agent(use_context)
...
def validate_orbital_output(tikz_code: str) -> tuple[bool, str]:
    """Validate TikZ code for orbital diagrams.
...
def get_orbital_context_for_classification() -> str:
    """Get reference context for orbital diagram generation.
    ...
    results = store.search(
        query="orbital electron configuration molecular orbital energy level",
    ...
    context = "\n\n## Reference Examples\n\n"
    context += "Here are some similar orbital diagrams from our reference library:\n\n"
