"""Workflow and pipeline models for VBAgent.

This module contains models for pipeline results, batch processing, and orchestration.
"""
...
from .content import IdeaResult
