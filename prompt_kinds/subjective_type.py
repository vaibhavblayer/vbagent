...
1.  **Problem Statement (`\item ...`)**
    ...
    *   **Multi-part sub-questions:** If the problem has sub-parts like (a), (b), (c), use `\begin{enumerate}[(a)]` with `\item` for each sub-part instead of manual `(a) ...\\` formatting. Example:
        ```latex
